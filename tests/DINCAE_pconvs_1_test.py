...
from models import DINCAE_pconvs_1, initialize_model_and_dataset_kind
...
class TestDINCAEPconvs(unittest.TestCase):
    def setUp(self):
        ...
        self.model = DINCAE_pconvs_1(self.params)
    ...
    def test_initalization_priority(self):
        ...
        model = DINCAE_pconvs_1(self.params,
    ...
    def test_automatic_initialization(self):
        ...
        model, dataset_kind = initialize_model_and_dataset_kind(self.params, "DINCAE_pconvs_1", dataset_params)
        
        # Check that the network has the correct attributes
        self.assertIsInstance(model, DINCAE_pconvs_1)
