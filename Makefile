...
NEXT_OPTIM_PATH = $(OPTIM_DIR)/$(OPTIM_BASENAME)_$(CURRENT_STUDY_IDX)$(OPTIM_FILE_EXT)
NEXT_STUDY_PATH = $(OPTIM_DIR)/$(STUDY_BASENAME)_$(CURRENT_STUDY_IDX)$(STUDY_FILE_EXT)
