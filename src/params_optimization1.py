###########################################################################
#
# Fix the number of epochs and initial lr, with lambda scheduler
# Optimize batch size and step size
# 
###########################################################################
...
class Objective():
    ...
    def import_params(self, params: dict):
        ...
        self.learning_rate = self.params["training"]["learning_rate"]
    ...
    def objective(self, trial: optuna.Trial):
        ...
        train.train(train_loader, test_loader, self.epochs)
