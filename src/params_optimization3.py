...
#   batch size
#   Optimize step size
#   Use train4, that does not require the params dictionary
# 
###########################################################################
...
class Objective():
    def __init__(self, model, epochs, loss_function, optimizer, min_val: float, max_val: float, nan_placeholder, train_loader, test_loader, step_size_range, lr_scheduler=None):
        # Load default config
